...
public class ProcedureDocumentService : IProcedureDocumentService
{
      ...
      int userId)
  {
    ...
    if (procDoc.Procedure == null)
      throw new Exception("El Procedure está en null");

    if (procDoc.Procedure.LegalProcess == null)
      throw new Exception("El LegalProcess está en null");

    // Si todo bien, comparar el usuario
